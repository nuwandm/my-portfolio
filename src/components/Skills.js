...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold bg-dark text-light shadow-dark py-3 px-6 cursor-pointer absolute dark:text-dark dark:bg-lime-200 "
  ...
  return (
    <>
      ...
      <div className="w-full h-screen realative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark">
        <motion.div
          className="flex items-center justify-center rounded-full font-semibold bg-dark text-light shadow-dark p-8 cursor-pointer  dark:text-dark dark:bg-lime-200  "
          whileHover={{ scale: 1.5 }}
        >
          web
        </motion.div>
