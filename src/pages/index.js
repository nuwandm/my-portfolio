        ...
        <Layout className="pt-0 md:p-16 sm:pt-8">
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center  ">
              ...
              I invite you to explore my portfolio of recent projects and articles, which highlight my proficiency web development technologies. From responsive design to seamless user experiences, I am committed to delivering outstanding results that exceed client expectations. 
              Let's create something amazing together!
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href='/Nuwan_Madusanka_CV.pdf'
                  target={"_blank"}
